...
- "categoryHint": categoría del gasto, una de la siguiente lista del usuario: ${categoryList}. Devolvé EXACTAMENTE uno de esos nombres si alguno aplica. Si ninguno se relaciona con el gasto, devolvé null.
- "suggestedNewCategory": SOLO cuando "categoryHint" es null porque ninguna categoría de la lista aplica, sugerí un nombre corto para una categoría nueva (1 o 2 palabras, en español, Tipo Título, ej. "Farmacia", "Mascotas"). Si alguna categoría de la lista aplica, devolvé null. No inventes una categoría nueva si alguna de la lista ya sirve.
